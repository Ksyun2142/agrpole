<script>
import DisplayForm from './DisplayForm3';
//import EditForm from './EditForm3';
import { FIELD_LIST,
         ORG_LIST,
         PLANTS_LIST,
         YEARS_LIST } from './constants3';
...
<template>
  <div id="app">
  <div class="wh">
  <a href="http://192.168.1.81:8080/two">СМЕННОЕ ЗАДАНИЕ</a>
   <br>
   <a href="http://192.168.1.81:8080/three">Урожай</a>
    <main class="main">
      <h2 class="form-title">Урожай</h2>
      <display-form
          v-if="!isEditForm"
